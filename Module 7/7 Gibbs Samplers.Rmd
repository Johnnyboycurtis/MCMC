...
We introduce the Gibbs sampler with  a two-stage example. The **two-stage Gibbs sampler algorithm** as described Robert & Casella goes as follows
...
print(mean(mu[burn_in:m])) #[1] 3.108575
