...
- Parametric sampling or parametric bootstrappin (target distribution part of a family of distributions)
...
Over the past few years, the use of Monte Carlo methods to calculate p-values has increased. The reasons for this include the following:
...
Though our ultimate decision to support the null hypothesis of dependence is not a surprise, our results show that the Monte Carlo *p*-value is greater than the raw p-value obtained from the calculated $\chi^2$ statistic indicating more support for the null hypothesis. 
